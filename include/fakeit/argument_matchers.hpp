...
//        template<typename T>
//        struct ArgThatMatcherCreator : public TypedMatcherCreator<T> {
//
//            virtual ~ArgThatMatcherCreator() = default;
//
//            ArgThatMatcherCreator(std::function<bool(T&)> matcher)
//                    : _expected(matcher) {
//            }
//
//            struct Matcher : public TypedMatcher<T> {
//                Matcher(std::function<bool(T&)> matcher)
//                        : _expected(matcher) {
//                }
//
//                virtual bool matches(const T &actual) const override {
...
//
//                virtual std::string format() const override {
//                    return std::string("ArgThat(?)");
//                }
//
//                const std::function<bool(T&)> _expected;
//            };
//
//            virtual TypedMatcher<T> *createMatcher() const override {
//                return new Matcher(this->_expected);
...
//    template<typename T>
//    internal::ArgThatMatcherCreator<T> ArgThat(bool(*matcher)(T&)) {
//        internal::ArgThatMatcherCreator<T> rv(matcher);
//        return rv;
//    }
