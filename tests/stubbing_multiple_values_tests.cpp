...
struct MultipleStubbing: tpunit::TestFixture {
	MultipleStubbing() :
			tpunit::TestFixture(
					//
					TEST(MultipleStubbing::stub_multiple_do_with_list),
					TEST(MultipleStubbing::stub_multiple_do_with_list_of_mixed_quatifiers_and_values),
					TEST(MultipleStubbing::stub_multiple_throws_with_list),
					...
					TEST(MultipleStubbing::stub_multiple_return_values_with_list),
