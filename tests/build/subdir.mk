...
%.o: ../%.cpp
	...
	g++ -D__GXX_EXPERIMENTAL_CXX0X__ -I"/home/eran/FakeIt/tests/../include" -O0 -g3 -Wall -c -fmessage-length=0 -std=c++11 -ftest-coverage -fprofile-arcs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
